...
router.post("/register", async (req, res) => {
  ...
  const newUser = new User({ username: req.body.username, password: hashedPassword, role: "user", name: req.body.name, languageLevelProgress: [], testHistory: [], notifications: [{ title: "Witaj w <> ...", content: "Poznawaj, ucz się, trenuj i poprawiaj swoje wyniki!" }] });
  newUser.save();
