...
router.get("/admin", async (req, res) => {
  ...
  router.post("/admin/questions/search", async (req, res) => {
    ...
    let questions;
    if (req.body.searchQueryLevel !== "Nothing" && req.body.searchQueryCategory !== "") {
      questions = await Question.find({ $and: [{ subject: { $regex: req.body.searchQueryCategory, $options: "i" } }, { languageLevel: req.body.searchQueryLevel }] }, (e, questions) => {
        if (e) console.log(e);
        return questions;
      });
    } else if (req.body.searchQueryLevel !== "Nothing" && req.body.searchQueryCategory === "") {
      questions = await Question.find({ languageLevel: req.body.searchQueryLevel }, (e, questions) => {
        if (e) console.log(e);
        return questions;
      });
    } else {
      questions = await Question.find({ subject: { $regex: req.body.searchQueryCategory, $options: "i" } }, (e, questions) => {
        if (e) console.log(e);
        return questions;
      });
    }
  ...
  router.post("/admin/lessons/search", async (req, res) => {
    ...
    let lessons;
    if (req.body.searchQueryLevel !== "Nothing" && req.body.searchQueryCategory !== "") {
      lessons = await Lesson.find({ $and: [{ subject: { $regex: req.body.searchQueryCategory, $options: "i" } }, { languageLevel: req.body.searchQueryLevel }] }, (e, lessons) => {
        if (e) console.log(e);
        return lessons;
      });
    } else if (req.body.searchQueryLevel !== "Nothing" && req.body.searchQueryCategory === "") {
      ...
      lessons = await Lesson.find({ subject: { $regex: req.body.searchQueryCategory, $options: "i" } }, (e, lessons) => {
        if (e) console.log(e);
        return lessons;
      });
    }
  ...
  router.post("/admin/subjects/search", async (req, res) => {
    ...
    let subjects;
    if (req.body.searchQueryLevel !== "Nothing" && req.body.searchQueryCategory !== "") {
      subjects = await Subject.find({ $and: [{ subject: { $regex: req.body.searchQueryCategory, $options: "i" } }, { languageLevel: req.body.searchQueryLevel }] }, (e, subjects) => {
        if (e) console.log(e);
        return subjects;
      });
    } else if (req.body.searchQueryLevel !== "Nothing" && req.body.searchQueryCategory === "") {
      ...
      subjects = await Subject.find({ subject: { $regex: req.body.searchQueryCategory, $options: "i" } }, (e, subjects) => {
        if (e) console.log(e);
        return subjects;
      });
    }
